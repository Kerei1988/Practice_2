...
### Задача №7. Расширенный анализ данных.
    ...
    # модуль data_ploting обновлен, добавлена 
...
# Пример работы функций
  Добро пожаловать в инструмент получения и построения графиков биржевых данных.
    ...
    Общие периоды времени для данных о запасах включают: 1д, 5д, 1мес, 3мес, 6мес, 1г, 2г, 5г, 10л, с начала года, макс.
    Введите тикер акции (например, «AAPL» для Apple Inc): AAPL
    Хотите выбрать стиль для графика введите "Yes", иначе "No": no
    Установите период для вычисления среднего отклонения(по умолчанию равно 20 дней - нажмите Enter): 
    Хотите ввести конкретные даты (введите 'Dates') или выбрать предустановленный период (введите 'Period'): period
    Введите период для данных (например, '1mo' для одного месяца): 1y
    График сохранен как AAPL_1y_stock_price_chart.png
...
### Задача №8. Интерактивный график
    # Использовать plotly или bokeh для создания интерактивных графиков.
        В моддуле data_plotting  реализована функция create_interactive_plot, которая  создаёт интерактивный график 
        с использованием Plotly.
        
        В модуль main интегрированна возможность выбора построения интерактивного или статического графика:
    ...
    Хотите ввести конкретные даты (введите 'Dates') или выбрать предустановленный период (введите 'Period'): period
    Введите период для данных (например, '1mo' для одного месяца): 1y
    Хотите создать интерактивный график? Введите 'Yes' или 'No': yes 